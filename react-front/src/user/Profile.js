...
class Profile extends Component {
    ...
    render() {
        const { redirtectToSignin, user, posts } = this.state;
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-md-4"> 
                        <img style={{width: '100%', height: '15vw', objectFit: 'cover'}} className="card-img-top" src={photoUrl} onError={i => (i.target.src = `${DefaultProfile}`)} alt={user.name} />
